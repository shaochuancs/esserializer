...
* Support following JavaScript builtin object and type: Boolean, Date, Error (and all 7 sub-error classes) Infinity, NaN, undefined, and more (with ESSerializer Pro): Symbol
