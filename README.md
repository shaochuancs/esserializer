...
* Support following JavaScript builtin object and type: BigInt, Boolean, Date, Error (and all 7 sub-error classes) Infinity, NaN, String, undefined, and more (with ESSerializer Pro): Symbol
